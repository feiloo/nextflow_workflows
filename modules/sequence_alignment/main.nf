...
workflow sequence_alignment {
  ...
  main:
    ...
    marked_bams = gatk_markduplicates(sorted_bams, args.intervals, args.library_type).marked_bams
    ...
    bam_recal_data = gatk_baserecalibrator(tagged_bams, args.refgenome, refgenome_index, refgenome_dict, args.known_sites, known_sites_index,  args.intervals, args.library_type)
    ...
    bam_recalibrated = gatk_apply_bqsr(bam_w_recal_data, args.refgenome, refgenome_index, refgenome_dict, args.intervals, args.library_type)
